...
##Pmod Header JXADC
##Sch name = XA1_P
set_property PACKAGE_PIN J3 [get_ports {VA[0]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {VA[0]}]
##Sch name = XA2_P
set_property PACKAGE_PIN L3 [get_ports {VB[0]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {VB[0]}]
##Sch name = XA3_P
#set_property PACKAGE_PIN M2 [get_ports {vp_in}]				
#	set_property IOSTANDARD LVCMOS33 [get_ports {vp_in}]
##Sch name = XA4_P
# set_property PACKAGE_PIN N2 [get_ports {vn_in}]				
	# set_property IOSTANDARD LVCMOS33 [get_ports {vn_in}]
##Sch name = XA1_N
set_property PACKAGE_PIN K3 [get_ports {VA[1]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {VA[1]}]
##Sch name = XA2_N
set_property PACKAGE_PIN M3 [get_ports {VB[1]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {VB[1]}]
##Sch name = XA3_N
#set_property PACKAGE_PIN M1 [get_ports {vn_in}]				
#	set_property IOSTANDARD LVCMOS33 [get_ports {vn_in}]
##Sch name = XA4_N
