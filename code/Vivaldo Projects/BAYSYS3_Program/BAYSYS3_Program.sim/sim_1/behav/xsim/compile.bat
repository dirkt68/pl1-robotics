...
REM
REM Generated by Vivado on Tue Feb 01 11:07:24 -0600 2022
...
echo "xvlog --incr --relax -prj motor_driver_tb_vlog.prj"
call xvlog  --incr --relax -prj motor_driver_tb_vlog.prj -log xvlog.log
