...
HD_PWD='C:/Users/dirkt/Documents/School/Project Lab 1/project-lab-1/test_project/test_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_adder.tcl
