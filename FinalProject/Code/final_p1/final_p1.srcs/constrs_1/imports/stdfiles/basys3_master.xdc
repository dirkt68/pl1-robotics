...
## Switches
set_property PACKAGE_PIN V17 [get_ports {motor}]
...
##Pmod Header JB
##Sch name = JB1
set_property PACKAGE_PIN A14 [get_ports {infraSensor[1]}]
...
##Sch name = JC4
set_property PACKAGE_PIN P18 [get_ports {actuatorPull}]
set_property IOSTANDARD LVCMOS33 [get_ports {actuatorPull}]
##Sch name = JC7
set_property PACKAGE_PIN L17 [get_ports {servoPhotoT}]
set_property IOSTANDARD LVCMOS33 [get_ports {servoPhotoT}]
##Sch name = JC8
set_property PACKAGE_PIN M19 [get_ports {RPhotoT}]
set_property IOSTANDARD LVCMOS33 [get_ports {RPhotoT}]
##Sch name = JC9
set_property PACKAGE_PIN P17 [get_ports {LPhotoT}]
set_property IOSTANDARD LVCMOS33 [get_ports {LPhotoT}]
##Sch name = JC10
