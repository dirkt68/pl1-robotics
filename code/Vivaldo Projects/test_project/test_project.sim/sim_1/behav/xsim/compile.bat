...
REM
REM Generated by Vivado on Tue Jan 25 19:32:04 -0600 2022
...
echo "xvlog --incr --relax -prj test_adder_tb_vlog.prj"
call xvlog  --incr --relax -prj test_adder_tb_vlog.prj -log xvlog.log
